...
public class LargestRange {
    ...
    /*Largest Range✩
Write a function that takes in an array of integers and returns an array of length2
...
of real integers.For instance,the output array[2,6]represents the range
{2,3,4,5,6},which is a range of length 5. Note that numbers don't need to be sorted
